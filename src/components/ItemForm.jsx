...
export default function ItemForm({ itemAtualizado }) {
  ...
  const [item, setItem] = useState(itemAtualizado ? itemAtualizado : defaultItem) //Se for passado a prop, sera o estado inicial da prop, caso contrario, o defaultItem
